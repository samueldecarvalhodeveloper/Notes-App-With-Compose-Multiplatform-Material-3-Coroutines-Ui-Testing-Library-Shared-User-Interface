...
class SystemTest {
    ...
    @BeforeTest
    fun beforeEach() {
        userViewModel = dev.mokkery.mock<UserViewModelMock>(autofill)
        userRepository = dev.mokkery.mock<UserRepository>()
        notesListingViewModel = dev.mokkery.mock<NotesListingViewModelMock>(autofill)
        noteRepository = dev.mokkery.mock<NoteRepository>()
        noteEditingViewModel = dev.mokkery.mock<NoteEditingViewModelMock>(autofill)
    }
